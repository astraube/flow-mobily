<template>
  <q-page class="q-px-md q-mb-lg" style="overflow: hidden">
    <q-card class="q-ma-xs">
      <div class="row q-col-gutter-sm q-ma-xs">
        <q-toolbar>
          <q-btn flat dense label="Hoje" class="q-mr-md bg-blue text-white" @click="calendarToday()"></q-btn>
          <q-btn flat dense round icon="keyboard_arrow_left" class="q-mr-sm bg-blue text-white" @click="calendarPrev()"></q-btn>
          <q-btn flat dense round icon="keyboard_arrow_right" class="bg-blue text-white" @click="calendarNext"></q-btn>
